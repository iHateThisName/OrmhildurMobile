...
{
    [CustomPropertyDrawer(typeof(AudioClipImportData))]
    public class AudioClipImportDataDrawer : PropertyDrawer
    {
        #region Variables
        ...
        public override float GetPropertyHeight(SerializedProperty property, GUIContent label)
        {
            ...
            CacheAudioClipImportData(audioClip.objectReferenceValue as AudioClip);
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            // cache AudioClipImportData if AudioClip updated in inspector
            if (changed)
            {
                audioClip.objectReferenceValue = audioClipRef;
                CacheAudioClipImportData(audioClipRef);
            }
        ...
        private void CacheAudioClipImportData(AudioClip audioClipRef)
        {
            if (AudioClipImportData.Editor_CreateAudioClipImportData(audioClipRef, out AudioClipImportData audioClipImportData))
            {
                fileName.stringValue = audioClipImportData.FileName;
                assetPath.stringValue = audioClipImportData.AssetPath;
                forceToMono.boolValue = audioClipImportData.ForceToMono;
                loadInBackground.boolValue = audioClipImportData.LoadInBackground;
                ambisonic.boolValue = audioClipImportData.Ambisonic;
                loadType.enumValueIndex = audioClipImportData.LoadType.ToInt();
                preloadAudioData.boolValue = audioClipImportData.PreloadAudioData;
                compressionFormat.enumValueIndex = audioClipImportData.CompressionFormat.ToInt();
                quality.floatValue = audioClipImportData.Quality;
                sampleRateSetting.intValue = audioClipImportData.Editor_SampleRateSetting.ToInt();
            }
            else
            {
